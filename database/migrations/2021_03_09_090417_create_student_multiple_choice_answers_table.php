...
class CreateStudentMultipleChoiceAnswersTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('student_multiple_choice_answers', function (Blueprint $table) {
            ...
            $table->foreign('question_id')->references('id')->on('multiple_choices')->onDelete('cascade');
            $table->foreign('answer_id')->references('id')->on('multiple_choice_answers')->onDelete('cascade');
