...
export class MultipleChoicesIndex extends Component {
    ...
    async handleSubmit(data) {
        ...
        let route = this.state.mode == 'create' ? `${routes.multipleChoices.create}/${this.props.match.params.chapter}` : `${routes.multipleChoices.edit}/${this.state.data.book_content_id}`
    ...
    render() {
        return (
            <Layout title={labels.multiple_choices}>{this.renderTemplate()}</Layout>
        )
    }
}
...
export default connect(null, mapDispatchToProps)(MultipleChoicesIndex)