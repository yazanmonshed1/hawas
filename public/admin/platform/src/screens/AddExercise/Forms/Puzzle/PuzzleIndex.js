...
export class PuzzleIndex extends Component {
    ...
    async handleSubmit(data) {
        ...
        let route = this.state.mode == 'create' ? `${routes.puzzle.create}/${this.props.match.params.chapter}` : `${routes.puzzle.edit}/${this.state.data.contents.book_content_id}`
    ...
    render() {
        return (
            <Layout title={labels.puzzle}>{this.renderTemplate()}</Layout>
        )
    }
}
...
export default connect(null, mapDispatchToProps)(PuzzleIndex)
