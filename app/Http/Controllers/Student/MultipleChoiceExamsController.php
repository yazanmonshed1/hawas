...
class MultipleChoiceExamsController extends Controller
{
    const OPERATORS = [
        'equal' => '=',
        'next' => '>',
    ...
    public function getQuestion(Request $request, $student_exam_id, $question_id = null, $type = 'equal', $q_no = 1)
    {
        ...
        if ($question) {
            ...
            return response()->json([
                'html' => view('student.activity.numQuestion')->with(compact('question', 'hide', 'answer_id', 'q_no', 'finished', 'one'))->render()
            ]);
        } else {
            return response()->json([
                'refresh' => true
    ...
    public function answerQuestion(Request $request, $student_exam_id, $question_id, $answer_id, $q_no)
    {
    ...
    {
        return StudentMultipleChoiceAnswer::where([
    ...
    {
        if ($question_id == null) {
            $targetAnswer = StudentMultipleChoiceAnswer::where([
        ...
        return $targetAnswer ? MultipleChoice::find($targetAnswer->question_id) : null;
    }
